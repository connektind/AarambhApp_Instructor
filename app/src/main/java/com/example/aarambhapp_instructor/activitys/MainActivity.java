...
import com.example.LiveSdk.file.ILiveVideoBroadcaster;
import com.example.LiveSdk.file.LiveVideoBroadcaster;
import com.example.LiveSdk.file.utils.Resolution;
import com.example.aarambhapp_instructor.R;
import com.example.aarambhapp_instructor.adapter.ChatBoxAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<ChatMessageModel> MessageList ;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            if (mLiveVideoBroadcaster == null) {
                ...
                mLiveVideoBroadcaster.init(MainActivity.this, mGLView);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        url=getIntent().getStringExtra("Live_Url");

        setContentView(R.layout.activity_main);
        messagetxt = (EditText) findViewById(R.id.message) ;
        send = (Button)findViewById(R.id.send);
        String teacher_name= AarambhSharedPreference.loadTeacherNameFromPreference(this);
        ...
        try {
            socket = IO.socket("http://35.200.220.64:3000");
            socket.connect();
            socket.emit("join", teacher_name);
            Log.e("Join Nickname", teacher_name);
                   ...
                   // String streamName = mStreamNameEditText.getText().toString();
                    ...
                    new AsyncTask<String, String, Boolean>() {
                        ...
                        protected void onPreExecute() {
                            progressBar = new ContentLoadingProgressBar(MainActivity.this);
                            progressBar.show();
                        }
    ...
    private void getLiveChatImplement() {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!messagetxt.getText().toString().isEmpty()){
                    String name=AarambhSharedPreference.loadTeacherNameFromPreference(MainActivity.this);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            ChatMessageModel m = new ChatMessageModel(nickname,message);
                            ...
                            chatBoxAdapter = new ChatBoxAdapter(MainActivity.this,MessageList);
